...
var { getNumLinesSpannedByNode,
    generateNodeUID,
    generateNewFunction,
    generateNewClassMethod } = require("./stubUtils.js");
                                    ...
                                    if (path.node.type == "ClassMethod" ||
                                        ...
                                        if (path.node.type == "ClassMethod" || path.node.type == "ObjectMethod") {
                                            ...
                                            if (path.node.id && path.node.id.name) {
                                                path.node.body = generateNewFunction(functionUIDName, path.node.id.name, path.node.type == "ArrowFunctionExpression",'withID') 
                                                // generateNewFunctionWithID();
                                            }
                                            else {
